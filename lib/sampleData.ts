...
export const NURSERY_MEAL_SAMPLE: MealMenu[] = [
  {
    date: '2026-03-02',
    lunch: 'のりたまごはん／鶏の照り焼き／切り干し大根の和え物／たまねぎとじゃがいものみそ汁',
    snack: 'りんご',
  },
  {
    date: '2026-03-03',
    lunch: 'お花のいろどりむすび／鮭のオーロラソース／ブロッコリーのおかか和え／菜の花と油麩のすまし汁',
    snack: 'ももゼリー',
  },
  {
    date: '2026-03-04',
    lunch: '具沢山ちゃんぽんめん／大学いも／のりとしらすのサラダ／ソフール いちご味',
    snack: '',
  },
  {
    date: '2026-03-05',
    lunch: '納豆ご飯（きりざい）／さばのごまねぎソース／茎わかめの炒り煮／はくさいとなすのみそ汁',
    snack: 'バナナ',
  },
  {
    date: '2026-03-06',
    lunch: 'マカロニグラタン／コーンとレタスのサラダ／ポトフスープ',
    snack: 'みかん',
  },
  {
    date: '2026-03-07',
    lunch: 'ねぎ塩にゅうめん／和風じゃがベー／青りんごゼリー',
    snack: '',
  },
  {
    date: '2026-03-09',
    lunch: '白飯／かじきのフライ／なっとうサラダ／せりと豚肉のみそ汁',
    snack: 'バナナ',
  },
  {
    date: '2026-03-10',
    lunch: 'タコライス／ウィンナーとアスパラのソテー／アーサー汁／チチヤスヨーグルト',
    snack: '',
  },
  {
    date: '2026-03-11',
    lunch: 'バターロール／スパニッシュオムレツ／トマトとキャベツのサラダ／ゴロゴロ野菜のミルクスープ',
    snack: 'バナナ',
  },
  {
    date: '2026-03-12',
    lunch: 'たらこスパゲッティ／スティックサラダ／肉団子スープ／青りんごゼリー',
    snack: '',
  },
  {
    date: '2026-03-13',
    lunch: 'チキンカレーライス／もやしとささみのナムル／かき玉汁',
    snack: 'バナナ',
  },
  {
    date: '2026-03-18',
    lunch: 'ハンバーガー／しましまハムチーズ／春セロリの鶏がらスープ／ピーチゼリー',
    snack: '',
  },
  {
    date: '2026-03-24',
    lunch: '麻婆豆腐丼／せんまいの3色ナムル／ビーフンスープ',
    snack: 'りんご',
  },
  {
    date: '2026-03-28',
    lunch: '五目豚肉うどん／鶏肉とさつまいもの洋風ソテー／チチヤスヨーグルト',
    snack: '',
  },
  {
    date: '2026-03-30',
    lunch: 'ミートソーススパゲティー／ウィンナーとアスパラのソテー／アーサー汁／チチヤスヨーグルト',
    snack: '',
  },
  {
    date: '2026-03-31',
    lunch: 'バターロール／ハンバーグ／マカロニサラダ／コーンスープ',
    snack: 'みかん',
  },
];
...
export const HOMEWORK_SAMPLE: HomeworkEntry[] = [
  { id: 'hw-1', date: '2026-03-16', subject: '国語', description: '自分はっけんファイルを読み返す', done: false },
  { id: 'hw-2', date: '2026-03-16', subject: '算数', description: '2年生のまとめプリント', done: true },
  { id: 'hw-3', date: '2026-03-18', subject: '国語', description: '2年生で学習した漢字の復習', done: false },
  { id: 'hw-4', date: '2026-03-19', subject: '生活', description: '1年間の思い出を絵日記に書く', done: false },
];
